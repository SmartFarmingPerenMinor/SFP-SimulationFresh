...
class worldBuilder:
    ...
    def addPlane(self, planeName :  str, x : float = 0, y: float = 0, z: float = 0, normX: float = 0, normY: float = 0, normZ: float = 1):
        rospy.sleep(1)
        ...
        print(" added %s to %s peripherals", planeName, self.emo.__class__.__name__)
